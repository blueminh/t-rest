...
import transformers
from lm_watermarking import extended_watermark_processor
...
# set up watermark
watermark_processor = extended_watermark_processor.WatermarkLogitsProcessor(vocab=list(great.tokenizer.get_vocab().values()),
                                               gamma=0.25,
                                               delta=2.0,
